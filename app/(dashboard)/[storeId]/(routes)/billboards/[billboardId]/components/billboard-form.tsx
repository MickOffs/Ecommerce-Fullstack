...
const BillboardForm: React.FC<BillboardFormProps> = ({ initialData }) => {
  ...
  const title = initialData ? "Modifica la billboard" : "Crea Billboard";
  const description = initialData
    ? "Modifica una billboard"
    : "Crea una nuova Billboard";
  const toastMessage = initialData
    ? "Billboard modificata"
    : "Billboard creata";
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      disabled={loading}
                      placeholder="Billboard Etichetta"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
